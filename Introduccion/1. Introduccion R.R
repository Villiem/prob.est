## Este fue .R fue escrito originalmente para un modulo de la ENOE, se usa bajo la licencia mostrada en
##Github. Todo el crédito para los autores. se puede consultar en https://github.com/jcms2665/TallerR_COLMEX
# Imparten:
# 
...
### LIBRERIAS
search()       # Busca bibliotecas instaladas
